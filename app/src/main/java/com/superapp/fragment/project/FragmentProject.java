...
public class FragmentProject extends BaseFragment {
    ...
    private void initProjectView() {
        ...
        if (PrefSetup.getInstance().getUserLoginType().equalsIgnoreCase("d")) {
            iv_editEstimatedHandoverDate.setVisibility(View.VISIBLE);
        } else {
...
//        dpd.setMinDate(Long.parseLong(ProjectUtils.getInstance().getFormattedDate(calendar)));
        et_newHandoverDate.setOnClickListener(v -> {
            java.util.Date dateObj = new java.util.Date(ProjectUtils.getInstance().getFormattedDate(calendar));
...
//            dpd.show(activity.getFragmentManager(), "Timepickerdialog");
                ...
                new InteractorImpl(activity, new OnResponseListener() {
                    ...
                    public void onSuccess(int requestCode, ResponsePacket responsePacket) {
                        if (responsePacket.getErrorCode() == 0) {
                            ...
                            ft.detach(FragmentProject.this).attach(FragmentProject.this).commit();
                        }
                    }
    ...
    private void updateCoWorkerView(ArrayList<CoworkerBean> coworkerList) {
        ...
        for (final CoworkerBean coworkerBean : coworkerList) {
            ...
            iv_coworkerPhotoId.setOnClickListener(v -> {
                PopupUtils.getInstance().showImageDialog(activity, coworkerBean.getPhotoId());
            });
    ...
    public void sendIDToClient(long coworkerId) {
        ...
        try {
            new InteractorImpl(activity, FragmentProject.this, Interactor.RequestCode_SendID, Interactor.Tag_SendID)
    ...
    public void projectComplete() {
        ...
        try {
            new InteractorImpl(activity, FragmentProject.this, Interactor.RequestCode_ProjectComplete, Interactor.Tag_ProjectComplete)
...
//        }
//        try {
//            new InteractorImpl(activity, FragmentProject.this, Interactor.RequestCode_DesignerRating, Interactor.Tag_DesignerRating)
...
//            DesignerRating();
    ...
    private void getAllReminders() {
        ...
        new InteractorImpl(activity, FragmentProject.this, Interactor.RequestCode_GetAllReminder, Interactor.Tag_GetAllReminder)
...
//                editProjectDetail();
    ...
    private void getProjectDetail() {
        ...
        try {
            new InteractorImpl(activity, FragmentProject.this, Interactor.RequestCode_GetProjectDetail, Interactor.Tag_GetProjectDetail)

...
public class AdapterArchivedProject extends RecyclerView.Adapter<AdapterArchivedProject.ViewHolder> {
    ...
    public AdapterArchivedProject(ApplicationContext activity, ArrayList<ProjectBean> projects, OnItemClickListener onItemClickListener) {

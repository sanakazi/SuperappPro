...
public class AdapterCoWorkerNew extends RecyclerView.Adapter<AdapterCoWorkerNew.ViewHolder> {
    ...
    public AdapterCoWorkerNew(ApplicationContext activity, ArrayList<CoworkerBean> coWorker, Boolean showCompleteDetail, OnItemClickListener onItemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view;
        if (viewType == 1) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_dashboard_coworker_item_new, parent, false);
        } else {
